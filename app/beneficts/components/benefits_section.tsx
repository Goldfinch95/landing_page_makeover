          ...
          {beneficios.map((item, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:flex-col sm:items-start sm:gap-4">
                {/* Icon box */}
                <div className="w-14 h-14 shrink-0 rounded-xl bg-[#E8B99A] flex items-center justify-center">
                  <FontAwesomeIcon
                    icon={item.icon}
                ...
                {/* Title — next to icon on mobile, below on desktop */}
                <h3 className="font-serif text-2xl font-bold text-[#1C0F0A] sm:mb-0">
                  {item.titulo}
                </h3>
              </div>
